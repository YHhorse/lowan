...
type DeviceListItem struct {
	...
	// Mode field. Return this fields is for compatible with 4.0 node management
	Mode string `protobuf:"bytes,13,opt,name=mode,proto3" json:"mode,omitempty"`
	// RfRegion field. Return this fields is for compatible with 4.0 node management, Could map to "Band".
	RfRegion string `protobuf:"bytes,14,opt,name=rf_region,json=rfRegion,proto3" json:"rf_region,omitempty"`
	// MacVersion fields. Return this fields is for compatible with 4.0 node management, could map to "LoRaWAN".
...
func (m *DeviceListItem) GetMode() string {
	if m != nil {
		return m.Mode
	}
	return ""
...
func (m *DeviceListItem) GetRfRegion() string {
	if m != nil {
		return m.RfRegion
	}
	return ""
...
func (m *DeviceListItem) GetMacVersion() string {
	if m != nil {
		return m.MacVersion
	}
	return ""
...
type CreateDeviceRequest struct {
	...
	// Device profile to create
	Profile *DeviceProfile `protobuf:"bytes,2,opt,name=profile,proto3" json:"profile,omitempty"`
	// Device keys to create
	Keys                 *DeviceKeys `protobuf:"bytes,3,opt,name=keys,proto3" json:"keys,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
func (m *CreateDeviceRequest) GetProfile() *DeviceProfile {
	if m != nil {
		return m.Profile
	}
	return nil
...
func (m *CreateDeviceRequest) GetKeys() *DeviceKeys {
	if m != nil {
		return m.Keys
	}
	return nil
...
type CreateDeviceListRequest struct {
	List                 []*CreateDeviceRequest `protobuf:"bytes,1,rep,name=list,proto3" json:"list,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}

func (m *CreateDeviceListRequest) Reset()         { *m = CreateDeviceListRequest{} }
func (m *CreateDeviceListRequest) String() string { return proto.CompactTextString(m) }
func (*CreateDeviceListRequest) ProtoMessage()    {}
func (*CreateDeviceListRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_57ec3c2ed36f7cf9, []int{4}
}

func (m *CreateDeviceListRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_CreateDeviceListRequest.Unmarshal(m, b)
}
func (m *CreateDeviceListRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_CreateDeviceListRequest.Marshal(b, m, deterministic)
}
func (m *CreateDeviceListRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CreateDeviceListRequest.Merge(m, src)
}
func (m *CreateDeviceListRequest) XXX_Size() int {
	return xxx_messageInfo_CreateDeviceListRequest.Size(m)
}
func (m *CreateDeviceListRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_CreateDeviceListRequest.DiscardUnknown(m)
}

var xxx_messageInfo_CreateDeviceListRequest proto.InternalMessageInfo

func (m *CreateDeviceListRequest) GetList() []*CreateDeviceRequest {
	if m != nil {
		return m.List
	}
	return nil
...
type GetDeviceResponse struct {
	...
	// Profile field. Return this fields is for compatible with 4.0 node management
	DeviceProfile *DeviceProfile `protobuf:"bytes,22,opt,name=deviceProfile,proto3" json:"deviceProfile,omitempty"`
	// SingleDeviceProfile. Indicate if this device is a imported 4.0 device which has one-one device profile.
	SingleDeviceProfile  bool     `protobuf:"varint,23,opt,name=SingleDeviceProfile,proto3" json:"SingleDeviceProfile,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *GetDeviceResponse) GetDeviceProfile() *DeviceProfile {
	if m != nil {
...
func (m *GetDeviceResponse) GetSingleDeviceProfile() bool {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*CreateDeviceListRequest)(nil), "api.CreateDeviceListRequest")
...
var fileDescriptor_57ec3c2ed36f7cf9 = []byte{
	...
	,
}
...
type DeviceServiceClient interface {
	...
	// 批量添加节点
	CreateList(ctx context.Context, in *CreateDeviceListRequest, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *deviceServiceClient) CreateList(ctx context.Context, in *CreateDeviceListRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/api.DeviceService/CreateList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DeviceServiceServer interface {
	...
	// 批量添加节点
	CreateList(context.Context, *CreateDeviceListRequest) (*empty.Empty, error)
	// Get returns the device matching the given DevEUI.
...
func (*UnimplementedDeviceServiceServer) CreateList(ctx context.Context, req *CreateDeviceListRequest) (*empty.Empty, error) {
...
func _DeviceService_CreateList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateDeviceListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DeviceServiceServer).CreateList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.DeviceService/CreateList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeviceServiceServer).CreateList(ctx, req.(*CreateDeviceListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _DeviceService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _DeviceService_CreateList_Handler,
		},
		{
			MethodName: "Get",
