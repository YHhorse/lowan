...
type HandleUplinkDataRequest struct {
	...
	// 丢包数
	LoseCnt              uint32   `protobuf:"varint,11,opt,name=LoseCnt,proto3" json:"LoseCnt,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *HandleUplinkDataRequest) GetLoseCnt() uint32 {
	if m != nil {
		return m.LoseCnt
	}
	return 0
...
func (m *HandleErrorRequest) GetReference() string {
	if m != nil {
		return m.Reference
	}
	return ""
...
func (m *HandleDownlinkACKRequest) GetReference() string {
	if m != nil {
		return m.Reference
	}
	return ""
...
var fileDescriptor_1d6d0f577a60e27d = []byte{
	...
	,
}
