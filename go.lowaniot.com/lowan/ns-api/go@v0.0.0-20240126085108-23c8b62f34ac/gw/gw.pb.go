...
type UplinkRXInfo struct {
	...
	// WifiMesh: Root Gateway ID.
	RootGatewayId []byte `protobuf:"bytes,20,opt,name=root_gateway_id,json=rootGatewayID,proto3" json:"root_gateway_id,omitempty"`
	// gateway score
	GatewayScore         float64  `protobuf:"fixed64,21,opt,name=gateway_score,json=gatewayScore,proto3" json:"gateway_score,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *UplinkRXInfo) GetRootGatewayId() []byte {
	if m != nil {
		return m.RootGatewayId
	}
	return nil
}

func (m *UplinkRXInfo) GetGatewayScore() float64 {
	if m != nil {
...
func (m *DownlinkTXInfo) GetRootGatewayId() []byte {
	if m != nil {
		return m.RootGatewayId
	}
	return nil
...
var fileDescriptor_b93a753e2b32e8e7 = []byte{
	...
	,
}
