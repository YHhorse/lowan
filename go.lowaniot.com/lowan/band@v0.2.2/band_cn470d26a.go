...
type cn470d26aBand struct {
	band
}

func (b *cn470d26aBand) CheckJoinFrequency(frequency int) bool {
...
func (b *cn470d26aBand) Name() string {
	return "CN470D26A"
}

func (b *cn470d26aBand) GetDefaults() Defaults {
	return Defaults{
		RX2Frequency:     492500000,
		RX2DataRate:      1,
		MaxFCntGap:       16384,
...
func (b *cn470d26aBand) GetDownlinkTXPower(freq int) int {
	return 14
}

func (b *cn470d26aBand) GetPingSlotFrequency(devAddr lorawan.DevAddr, beaconTime time.Duration) (int, error) {
	return 494900000, nil
}

func (b *cn470d26aBand) GetRX1ChannelIndexForUplinkChannelIndex(uplinkChannel int) (int, error) {
	return uplinkChannel % 24, nil
}

func (b *cn470d26aBand) GetRX1FrequencyForUplinkFrequency(uplinkFrequency int) (int, error) {
...
func (b *cn470d26aBand) GetRX1FrequencyForJoinFrequency(joinFrequency int) (int, error) {
	return 492500000, nil
}

func (b *cn470d26aBand) GetRX2Frequency(frequency int, isABP bool) int {
	return b.GetDefaults().RX2Frequency
}

func (b *cn470d26aBand) GetRX2DataRate(uplinkDR int, drOffset int) int {
	return b.GetDefaults().RX2DataRate
}

func (b *cn470d26aBand) ImplementsTXParamSetup(protocolVersion string) bool {
	return false
}

func (b *cn470d26aBand) GetDefaultMaxUplinkEIRP() float32 {
	return 19.15
}

func newCN470D26ABand(repeaterCompatible bool) (Band, error) {
	b := cn470d26aBand{
		band: band{
	...
	// Additional frequencies from 494.9 to 495.9 MHz are available for configurable downlink parameters (beacon frequency, ping-slot frequency and RX2 frequency).
	for i := 0; i < 24; i++ {
		b.downlinkChannels[i] = Channel{
			Frequency: 490100000 + (i * 200000),
			MinDR:     0,
			MaxDR:     5,
			enabled:   true,
		}
