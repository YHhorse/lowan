...
func (b *kr920Band) GetRX1FrequencyForJoinFrequency(joinFrequency int) (int, error) {
	return b.GetRX1FrequencyForUplinkFrequency(joinFrequency)
}

//TODO
func (b *kr920Band) CheckJoinFrequency(frequency int) bool {
	return true
}
...
func (b *kr920Band) GetRX2Frequency(frequency int, isABP bool) int {
	return b.GetDefaults().RX2Frequency
}

func (b *kr920Band) GetRX2DataRate(uplinkDR int, drOffset int) int {
