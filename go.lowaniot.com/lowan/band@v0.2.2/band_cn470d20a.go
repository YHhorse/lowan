...
type cn470d20aBand struct {
	band
}

func (b *cn470d20aBand) CheckJoinFrequency(frequency int) bool {
...
func (b *cn470d20aBand) Name() string {
	return "CN470D20A"
}

func (b *cn470d20aBand) GetDefaults() Defaults {
	return Defaults{
...
func (b *cn470d20aBand) GetDownlinkTXPower(freq int) int {
	return 14
}

func (b *cn470d20aBand) GetPingSlotFrequency(devAddr lorawan.DevAddr, beaconTime time.Duration) (int, error) {
...
func (b *cn470d20aBand) GetRX1ChannelIndexForUplinkChannelIndex(uplinkChannel int) (int, error) {
	return uplinkChannel % 64, nil
}

func (b *cn470d20aBand) GetRX1FrequencyForUplinkFrequency(uplinkFrequency int) (int, error) {
...
func (b *cn470d20aBand) GetRX1FrequencyForJoinFrequency(joinFrequency int) (int, error) {
	return b.GetRX1FrequencyForUplinkFrequency(joinFrequency)
}

func (b *cn470d20aBand) GetRX2Frequency(frequency int, isABP bool) int {
	if isABP {
		return b.GetDefaults().RX2Frequency
	} else {
		upIndex, _ := b.GetUplinkChannelIndex(frequency, true)

		rx2Index := (upIndex/8)*8 + 7
		return b.downlinkChannels[rx2Index].Frequency
	}
}

func (b *cn470d20aBand) GetRX2DataRate(uplinkDR int, drOffset int) int {
	return b.GetDefaults().RX2DataRate
}

func (b *cn470d20aBand) ImplementsTXParamSetup(protocolVersion string) bool {
	return false
}

func (b *cn470d20aBand) GetDefaultMaxUplinkEIRP() float32 {
	return 19.15
}

func newCN470D20ABand(repeaterCompatible bool) (Band, error) {
	b := cn470d20aBand{
		band: band{
	...
	for i := 32; i < 64; i++ {
		b.uplinkChannels[i] = Channel{
			Frequency: 503500000 + ((i - 32) * 200000),
			MinDR:     0,
			MaxDR:     5,
			enabled:   true,
		}
	...
	for i := 4; i < 8; i++ {
		b.joinChannels[i] = Channel{
			Frequency: 504100000 + ((i - 4) * 1600000),
			MinDR:     0,
			MaxDR:     5,
			enabled:   true,
		}
