...
func (b *cn470Band) GetRX1FrequencyForJoinFrequency(joinFrequency int) (int, error) {
	return b.GetRX1FrequencyForUplinkFrequency(joinFrequency)
}

//TODO
func (b *cn470Band) CheckJoinFrequency(frequency int) bool {
	return true
}
...
func (b *cn470Band) GetRX2Frequency(frequency int, isABP bool) int {
	return b.GetDefaults().RX2Frequency
}

func (b *cn470Band) GetRX2DataRate(uplinkDR int, drOffset int) int {
